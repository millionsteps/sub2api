...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/export-data", h.Admin.Account.ExportDataByRequest)
		accounts.POST("/get-by-file-names", h.Admin.Account.GetByFileNames)
		accounts.POST("/replace-by-file-names", h.Admin.Account.ReplaceByFileNames)
		accounts.POST("/delete-by-file-names", h.Admin.Account.DeleteByFileNames)
